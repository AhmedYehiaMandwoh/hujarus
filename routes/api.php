...
Route::group(['prefix' => 'clients', 'as' => 'clients.'], function () {
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('/login', Clients\ClientLoginAction::class)->name('register');
        Route::post('/update-profile-image', Clients\ClientsUpdateProfileImageAction::class);

    });
    Route::group(['prefix' => 'addresses', 'as' => 'addresses.'], function () {
        Route::post('/{address}', Clients\Adress\ClientAddressUpdateAction::class);
        Route::delete('/{address}', Clients\Adress\ClientAddressDeleteAction::class);
        Route::post('/', Clients\Adress\ClientAddressStoreAction::class);
        Route::get('/', Clients\Adress\ClientAddressFetchAllAction::class);
    });
