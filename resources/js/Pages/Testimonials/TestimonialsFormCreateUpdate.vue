<template>
    <ElPanelCreate :is-transparent="false" v-if="$page.url == '/testimonials/create'" />
...
const submit = () => {
    ...
    el_form.post(is_create ? route('testimonials.store') : route('testimonials.update', el_form.id), {
        onSuccess: () => {
